...
> **Есть вторая реализация.** В ветке [`file-logs`](../../tree/file-logs) логи контейнеров собираются чтением файлов, а не драйвером логирования Loki.
> 
...
- **Файловый сбор логов** вместо драйвера — реализовано в ветке [`file-logs`](../../tree/file-logs): promtail читает `/var/lib/docker/containers/*/*-json.log`. Устраняет круговую зависимость и требование запускать Loki первым.
